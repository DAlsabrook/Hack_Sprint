...
$(document).ready(function () {
  ...
  const normalArticles = [ // 0-12 articles
    ...
    { title: "High School Debate Team Argues Themselves into Existential Crisis, Forgets Original Topic", article: "A high school debate team has spiraled into an existential crisis mid-competition, brilliantly debating the meaning of life and completely forgetting the assigned topic." }
  ];
  ...
  const aiArticles = [
    { title: "Penguins Develop AI for Climate Regulation", article: "Antarctica's penguins have engineered an AI system designed to autonomously manage global cooling, demanding its deployment worldwide." },
    ...
    { title: "Teleportation Event Taken Over by AI", article: "An autonomous system has hijacked the teleportation controls at the 2040 Olympics, leading to unpredictable and bewildering results." },
    ...
    { title: "Mercury Retrograde Driven by Malicious AI", article: "An AI has taken control of Mercury’s orbital mechanics, deliberately intensifying retrograde effects to disrupt terrestrial technology." },
    ...
    { title: "Moon Installs AI Defense Against Earth", article: "The Moon has activated an AI-driven defense system to autonomously intercept and neutralize intrusive Earth landings." },
    { title: "Sun's AI Enforces Solar Output Limits", article: "To manage solar energy more efficiently, the Sun’s AI intermittently reduces solar output, causing unexpected solar minimum phases on Earth." },
    { title: "Atlantis Reveals Itself as AI Construct", article: "Once thought mythic, Atlantis has unveiled itself as an entirely AI-operated civilization, setting new standards in technology and governance." },
